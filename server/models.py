...
class Employee(db.Model):
    ...
    # Association proxy to get projects for this emplyee through assignments
...
class Meeting(db.Model):
    ...
    # Realtionship mapping the meeting to related employees
...
# Association Model to store many to many relation between employee and project
class Assignment(db.Model):
    ...
    # ForeignKey to store the employee id
    employee_id = db.Column(db.Integer, db.ForeignKey('employees.id'))

    # ForeignKey to store project id
    ...
    # Relationship mapping to store the assignment to related project
